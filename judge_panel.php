...
================================================== -->
     <?php
        ...
        ?>
                 ...
                 <!-- Subhead
================================================== -->
<table style="width: 100%; background: linear-gradient(180deg, #071a8d 0%, #7e7e7f57 100%) !important; height: 150px; text-indent: 25px; color: #fff; border-bottom-right-radius: 42px; border-bottom-left-radius: 42px;" align="center" border="0"> <td>
                         <h1 style="color: whitesmoke !important; text-align: center;">Judge's Panel</h1>

                             <h4 style="color: whitesmoke !important; text-align: center;">Automatic Tabulation System</h4>
                         </td>
                     </tr>
                 </table>
