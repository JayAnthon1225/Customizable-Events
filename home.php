...
================================================== -->
                                      ...
                                      <div style="border: 0px !important;" class="accordion-group">
                                        ...
                                        <div class="collapse indent" id="listSubEvents<?php echo $main_event_id; ?>">
                                          ...
                                          <table align="center" class="table table-bordered" id="example">
                                            ...
                                            <thead>
                                              <th><strong>Competition Title</strong></th>
                                              <th>
                                                ...
                                                <td>
                                                        ...
                                                        <tr>
                                                          <td>
                                                            ...
                                                            <form method="POST">
                                                              ...
                                                              <input name="se_new_name" type="text" placeholder="Enter Competition Title" value="<?php echo $sub_event_row['event_name']; ?>" />
                                                              <br />
                                                  ...
                                                  ?>
                                                    ...
                                                    <script>
                                                      ...
                                                      alert('Competition title: <?php echo $se_name . " was changed to: " . $se_new_name; ?> successfully!');
                                                    </script>
                                                          ...
                                                          <td>
                                                            ...
                                                            <?php } else { ?>
                                                              <div class="alert alert-warning">
                                                                <h3>Cannot delete Competition. There are saved data for this Competition.</h3>
                                                              </div>
                                                  ...
                                                  ?>
                                                      ...
                                                      <script>
                                                        window.location = 'home.php';
                                                        alert('Competition: <?php echo $se_name; ?> and its related data deleted successfully. . .');
                                                      </script>
                                            ...
                                            <?php } else { ?>
                                              ...
                                              <tr>
                                                <td colspan="3">
                                                  <div class="alert alert-warning">
                                                    <h3>
                                                      No data to display. Add Competition <a href="#" data-toggle="collapse" data-target="#addSubEvents<?php echo $main_event_id; ?>" data-parent="#myGroup<?php echo $main_event_id; ?>"> here &raquo;</a>
                                                    </h3>
                                                  </div>
                                                </td>
                                              </tr>
                                            ...
                                            <tr>
                                              <td>
                                                ...
                                                <form method="POST">
                                                  ...
                                                  <input placeholder="Enter Competition title" name="sub_event_name" class="form-control btn-block" style="text-indent: 7px !important; height: 30px !important;" type="text" required="true" />
                                                  <br />
                                                  ...
                                                  <strong>Venue</strong>:<br />
                                                  <textarea placeholder="Enter Competition Venue" rows="2" name="event_place" class="form-control btn-block" style="text-indent: 7px !important;" required="true"></textarea>
                                                  <br />
                                              ...
                                              <td>
                                                ...
                                                <form method="POST">
                                                  ...
                                                  ?>
                                                    ...
                                                    <strong>Venue:</strong><br />
                                                    <textarea placeholder="Enter Competition Venue" rows="2" name="place" class="form-control btn-block" style="text-indent: 7px !important;" required="true"><?php echo $edit_event_row['place']; ?></textarea>
  ...
  values('$main_event_id','$sub_event_name','deactivated','$event_date','$event_time','$event_place','$session_id')");
          ...
          ?>
            <script>
              window.location = 'home.php';
              alert('Competition <?php echo $sub_event_name; ?> created successfully!');
            </script>
          <?php } ?>
          ...
          ?>
              ...
              <script>
                window.location = 'home.php';
                alert('Event: <?php echo $ma_name; ?> and its Competition and related data deleted successfully. . .');
              </script>
